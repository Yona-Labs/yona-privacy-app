...
import { publicKeyToFieldElement } from '../utils/getExtDataHash';
/**
...
export class Utxo {
    ...
    constructor({
        ...
        index = 0,
        mintAddress, // Default to Solana native SOL mint address,
    }: {
        ...
        this.index = index;
        this.mintAddress = mintAddress ? publicKeyToFieldElement(mintAddress) : publicKeyToFieldElement('So11111111111111111111111111111111111111112');
    }
